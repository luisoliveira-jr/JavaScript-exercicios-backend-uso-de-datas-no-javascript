function taAberto(momentoClienteChegou) {
    ...
    // caso o setHours() apresentar problema no segundo console.log use dessa maneira abaixo 
    // fechamento.setHours(12)
    // fechamento.setMinutes(0)
    // fechamento.setSeconds(0)
    // fechamento.setMilliseconds(0)
